        ...
        <div className="store-products-container">
            <header className="store-header">
                <div className="header-content">
                    ...
                    <button className="add-product-btn" onClick={() => { navigate(`/stores/${id}/addnewproduct`) }}>
                        + Add New Product
                    </button>
                </div>
            </header>
            ...
            <div className="products-grid">
                {showProducts.length > 0 ? showProducts : <p className="no-products">No products found in this store.</p>}
            </div>
        </div>
    )
}
